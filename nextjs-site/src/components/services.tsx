...
const SERVICES: Service[] = [
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4 4 0 0 1 4 4v2a4 4 0 0 1-8 0V6a4 4 0 0 1 4-4z"/><path d="M16 14H8a4 4 0 0 0-4 4v2h16v-2a4 4 0 0 0-4-4z"/><circle cx="19" cy="5" r="2"/><path d="M19 7v2"/></svg>
    ),
  ...
  },
  {
    ...
    desc: 'Automated Answer Engine Optimization — scrape, cluster, build. We generate authoritative content sites at scale with structured schema and entity locking.',
  ...
  },
  {
    ...
    desc: 'End-to-end SMS workflows for restaurants, real estate, insurance, and local services. Speed-to-lead, drip sequences, AI response agents.',
    tags: ['Twilio', 'n8n', 'GHL'],
  ...
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 18 22 12 16 6"/><path d="M8 6 2 12 8 18"/><path d="m14.5 4-5 16"/></svg>
    ),
...
export default function Services() {
  ...
  return (
    <section id="services" className="py-[var(--section-pad)]">
      <div className="container">
        <AnimatedContent>
          <span className="section-label">// what we build</span>
        </AnimatedContent>
        <AnimatedContent delay={0.1}>
          <h2 className="section-title">What We Build (And Why It Works)</h2>
        </AnimatedContent>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.map((service, i) => (
            <AnimatedContent key={i} delay={i * 0.08}>
              <SpotlightCard
                className={`rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] p-6 cursor-pointer transition-all duration-300 ${
                  service.featured ? 'md:col-span-2' : ''
                } ${expandedIndex === i ? 'border-[var(--border-accent)]' : 'hover:border-[var(--text-muted)]'}`}
              ...
              >
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="text-[var(--text-muted)] text-xl transition-transform duration-300" style={{
